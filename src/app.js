...
class App extends Component {
    ...
    switchLanguage = (language) => (ev) => this.setState({language})
    ...
    render() {
        return (
            <LangProvider language={this.state.language}>
                <div>
                    <ul>
                        <li onClick={this.switchLanguage('en')}><button>English</button></li>
                        <li onClick={this.switchLanguage('ru')}><button>Русский</button></li>
                    </ul>
                </div>
